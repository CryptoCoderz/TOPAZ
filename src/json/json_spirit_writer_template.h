...
namespace json_spirit
{
    ...
    class Generator
    {
        ...
        typedef typename String_type::value_type Char_type;
        typedef typename Object_type::value_type Obj_mTopazCoin_type;
    ...
    private:
        ...
        void output( const Obj_mTopazCoin_type& mTopazCoin )
        {
            output( Config_type::get_name( mTopazCoin ) ); space(); 
            os_ << ':'; space(); 
            output( Config_type::get_value( mTopazCoin ) );
        }
